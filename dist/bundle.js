...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        if (typeof options.startDate === 'undefined' && typeof options.endDate === 'undefined') {
            if ($$$1(this.element).is('input[type=text]')) {
        ...
        this.container.find('.calendar')
            ...
            .on('mouseleave.daterangepicker', 'td.available', $$$1.proxy(this.updateFormInputs, this))
            ...
            .on('click.daterangepicker', '.daterangepicker_input input', $$$1.proxy(this.showCalendars, this))
            .on('focus.daterangepicker', '.daterangepicker_input input', $$$1.proxy(this.formInputsFocused, this))
            .on('blur.daterangepicker', '.daterangepicker_input input', $$$1.proxy(this.formInputsBlurred, this))
            .on('change.daterangepicker', '.daterangepicker_input input', $$$1.proxy(this.formInputsChanged, this))
            .on('keydown.daterangepicker', '.daterangepicker_input input', $$$1.proxy(this.formInputsKeydown, this));
        ...
        this.container.find('.ranges')
            ...
            .on('mouseenter.daterangepicker', 'li', $$$1.proxy(this.hoverRange, this))
            .on('mouseleave.daterangepicker', 'li', $$$1.proxy(this.updateFormInputs, this));
    ...
    DateRangePicker.prototype = {
        ...
        move: function() {
            ...
            if (this.opens == 'left') {
                ...
                if (this.container.offset().left + this.container.outerWidth() > $$$1(window).width()) {
                    this.container.css({
                        left: 'auto',
                        right: 0
                    });
        ...
        clickPrev: function(e) {
            var cal = $$$1(e.target).parents('.calendar');
        ...
        monthOrYearChanged: function(e) {
            var isLeft = $$$1(e.target).closest('.calendar').hasClass('left'),
        ...
        timeChanged: function(e) {
            ...
            var cal = $$$1(e.target).closest('.calendar'),
        ...
        formInputsChanged: function(e) {
            var isRight = $$$1(e.target).closest('.calendar').hasClass('right');
