...
(function(root, factory) {
  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.parentElObject = (options.parentEl && $(options.parentEl).length) ? $(options.parentEl) : $(this.parentEl);
        this.container = $(options.template).appendTo(this.parentElObject);
        //
        ...
        if ((this.alwaysShowCalendar || typeof options.ranges === 'undefined') && !this.singleDatePicker) {
    ...
    DateRangePicker.prototype = {
        ...
        move: function() {
            ...
            if (!this.parentElObject.is($('body'))) {
                parentOffset = {
                    top: this.parentElObject.offset().top - this.parentElObject.scrollTop(),
                    left: this.parentElObject.offset().left - this.parentElObject.scrollLeft()
                };
                parentRightEdge = this.parentElObject[0].clientWidth + this.parentElObject.offset().left;
            }
