...
module.exports = React.createClass({
	$picker: null,
	options: [
	    'startDate', 'endDate', 'minDate', 'maxDate', 'dateLimit', 'timeZone', 'showDropdowns',
	    'showWeekNumbers', 'timePicker', 'timePickerIncrement', 'timePicker24Hour',
	    'timePickerSeconds', 'ranges', 'opens', 'drops', 'buttonClasses', 'applyClass',
	    'cancelClass', 'locale', 'singleDatePicker', 'parentEl', 'alwaysShowCalendar'
	],
